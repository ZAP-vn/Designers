...
export const StandardInput = forwardRef<HTMLInputElement | HTMLTextAreaElement, StandardInputProps>(({
    themeState,
    label,
    icon: Icon,
    rightIcon: RightIcon,
            ...
            <div className="relative w-full">
                ...
                {multiline ? (
                    <textarea
                        ...
                        onBlur={(e) => { setIsFocused(false); setHasValue(!!e.target.value); props.onBlur?.(e as any); }}
