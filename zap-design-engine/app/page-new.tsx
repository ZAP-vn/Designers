...
const App: React.FC = () => {
    ...
    return (
        <div className={`flex flex-col h-screen bg-white dark:bg-slate-900 text-gray-900 dark:text-white overflow-hidden font-sans ${isDarkMode ? 'dark' : ''}`}>
            ...
            <div className="flex-1 flex overflow-hidden bg-[#F9FAFB] dark:bg-slate-950 relative">
                ...
                {(viewMode === 'preview') ? (
                    ...
                    <>
                        ...
                        <aside className={`h-full bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-800 transition-all duration-300 ease-[cubic-bezier(0.2,0,0,1)] overflow-hidden shrink-0 flex flex-col ${isExplorerOpen ? 'w-[280px]' : 'w-0 border-none'}`}>
                                ...
                                {activeTab === 'docs' ? (
                                    ...
                                    <div className="flex-1 overflow-y-auto custom-scrollbar">
                                        <div className="w-full max-w-[1600px] mx-auto p-6 md:p-8 pb-32">
                                            ...
                                            {activeTab === 'templates' && <TemplateSection config={projectConfig} themeState={themeState} onUpdateConfig={handleTemplateConfigUpdate} showClassNames={showClassNames} />}
                                        </div>
                                    </div>
                                )}
                            </div>
