...
description: Generate Vitest + React Testing Library tests for components, hooks, and utilities. Triggers on testing, spec files, coverage, Vitest, RTL, unit tests, integration tests, or write/review test requests.
---

# Frontend Testing Skill

This skill enables the Agent to generate high-quality, comprehensive frontend tests following established conventions and best practices.
...
- Uses complexity analysis output as context
...
- **Testing Docs** - The canonical testing specification.
