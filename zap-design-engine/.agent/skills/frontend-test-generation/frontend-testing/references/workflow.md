...
This document outlines the step-by-step workflow for generating and verifying frontend tests.ially for complex components or directories with multiple files.
...
2. Run `npm run analyze-component <path>` (if available)
3. Check complexity score and features detected
4. Write the test file
5. Run test: `npm test <file>.spec.tsx`
6. Fix any failures
...
# Check coverage
npm run test:coverage path/to/directory/
```

## Component Complexity Guidelines

Use `npm run analyze-component <path>` to assess complexity before testing.
...
Write component-a.spec.tsx
Run npm test component-a.spec.tsx ✅
Write component-b.spec.tsx
Run npm test component-b.spec.tsx ✅
...continue...
```
